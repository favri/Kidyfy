      ...
      <div class="row">
        <div class="row">
            <div class="col-sm-10 col-sm-offset-1 commentbox bkg-white brd-top">
              <span class="icon-post pull-right"><i class="fa fa-briefcase"></i></span>
              <h3>Indumentaria</h3>
              <p class="font-size-medium">¿Listo para Kidyar {{\Auth::user()->name}}?</p>
               ...
               <form class="" method="post" action="/indumentaria/{{\Auth::user()->id}}" enctype="multipart/form-data">
                 {{ csrf_field() }}
                 ...
                 <input type="number" name="group_id" value="4" hidden>
